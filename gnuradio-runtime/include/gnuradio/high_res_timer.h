...
inline gr::high_res_timer_type gr::high_res_timer_now(void) { return mach_absolute_time(); }
...
inline gr::high_res_timer_type gr::high_res_timer_epoch(void) {
    ...
    boost::posix_time::time_duration utc =
        boost::posix_time::microsec_clock::universal_time() - boost::posix_time::from_time_t(0);
